...
import { ValueTimeLineSimple } from "./value-timeline";
import { TestLog } from "myy-common";

import { ValueTimeLineWrapper } from "./value-timeline";
...
function test_ValueTimeLineSimple() {
	...
	console.log('timeLine, value change', 
		stateHistory.value, stateHistory.timeLine);
