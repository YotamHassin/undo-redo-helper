...
function test_ValueTimeLineSimple() {
    ...
    console.log('timeLine.past change, value change', stateHistory.value);
...
function test_ValueTimeLineWrapper() {
    ...
    // if not undefined => add as first value (last undo is always undefined).
    // trigger 0
    var stateHistory = new value_timeline_1.ValueTimeLineWrapper(undefined, myy_common_1.getLog('stateHistory.eventHandler init test:'));
...
function test() {
    var testLog = myy_common_1.TestLog.i('History State');
